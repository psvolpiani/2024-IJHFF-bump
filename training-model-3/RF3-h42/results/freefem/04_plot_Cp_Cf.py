...
ax.plot(x_nn1/c,p_nn1/q,color='C3',linestyle='--',label='RANS-RF3')
ax.legend()
...
fig.savefig('./results/h'+nummesh+'/fig_cp_loc_h'+nummesh+'_rf3.pdf', dpi=300)
...
ax2.plot(x_nn1/c,c_nn1/q,color='C3',linestyle='--',label='RANS-RF3')
ax2.legend()
...
fig.subplots_adjust(left=0.2)
fig.subplots_adjust(bottom=0.20)
fig.savefig('./results/h'+nummesh+'/fig_cf_loc_h'+nummesh+'_rf3.pdf', dpi=300)
plt.show()
